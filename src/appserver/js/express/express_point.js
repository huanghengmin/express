Ext.onReady(function () {
            ...
            listeners: {
                click: function () {
                 ...
                 /*   var phone = Ext.fly("phone.tb.info").dom.value == '输入快递员电话'
                    ...
                    /*    var express_code = Ext.fly("express_code.tb.info").dom.value == '输入快递公司'
                     ? null
    ...
    var record = new Ext.data.Record.create([
        ...
        {name: 'express_company_point', mapping: 'express_company_point'},
        {name: 'express_number', mapping: 'express_number'},
        {name: 'sendTime', mapping: 'sendTime'}
    ]);
    var proxy = new Ext.data.HttpProxy({
        url: "../../ExpressRealNameAction_findByPoint.action"
    });
    ...
    var colM = new Ext.grid.ColumnModel([
        ...
        {header: "快递公司网点", dataIndex: "express_company_point", align: 'center', sortable: true, menuDisabled: true},
