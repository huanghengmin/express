Ext.onReady(function () {
    ...
    var proxy = new Ext.data.HttpProxy({
        url: "../../ExpressRealNameAction_find.action"
    });
...
function show_flag() {
    return String.format(
        ...
        //'<a id="map_location.info" href="javascript:void(0);" onclick="map_location();return false;" style="color: green;">位置</a>&nbsp;&nbsp;&nbsp;' +
...
/*
 初始化地图
 */
/*function initMap(div,longitude,latitude){
    /!*
     初始化地图
     *!/
...
/*function map_location() {
    ...
    //GPS坐标
    //var x = recode.get("longitude");
    //var y = recode.get("latitude");
    //var ggPoint = new BMap.Point(x, y);
    //地图初始化
    //var bm = new BMap.Map("GMap");
