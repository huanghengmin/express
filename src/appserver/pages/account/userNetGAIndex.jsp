...
<html version="-//W3C//DTD HTML 4.01 Transitional//EN">
    <head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/user/user_point.js"></script>
    </head>
...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/account/userGAIndex.js"></script>
</head>
