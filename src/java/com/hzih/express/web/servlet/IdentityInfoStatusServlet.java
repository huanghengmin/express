...
//        calendar.set(Calendar.HOUR_OF_DAY, 0);
        ...
        timer.schedule(new IdentityInfoStatusTask(expressLogDao), time,  Long.parseLong(CompareConfigXml.getAttribute(CompareConfigXml.compare_days))*1000L * 60L * 60L * 24L);
//        timer.schedule(new IdentityInfoStatusTask(expressLogDao), time, 1000L *5L);
    }
